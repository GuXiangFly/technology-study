...
//		java.util.Map<Integer, Integer> d = new BSTMap<Integer,Integer>();
//
...
//	}
//
//	public static void add_key_values (java.util.HashMap<String, Integer> hm, String keys[], int[] values, int count){
...
//		java.util.Map<String, Integer> d = A7Tester.<String,Integer>createMap();
//
//		displayResults(d.size() == 0 ,"size");
//		d.put("abc", 10);
//
...
//		System.out.println("**** begin map stress test");
//		java.util.Map<Integer, Integer> d = A7Tester.<Integer,Integer>createMap();
//
//		for (int i = 0; i < 10000; i++) {
//			d.put(i,i);
//		}
